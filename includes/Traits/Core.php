...
trait Core
{
    ...
    public function get_ext_toc_global_settings($post_id, $document, $global_settings){
        ...
        if ($document->get_settings('eael_ext_toc_global') == 'yes' && $document->get_settings('eael_ext_table_of_content') == 'yes') {
            ...
            $global_settings_toc = [
                ...
                'eael_ext_toc_border_color' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_toc_border_color'),
                ...
                'eael_ext_table_of_content_header_text_color' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_table_of_content_header_text_color'),
                ...
                'eael_ext_table_of_content_close_button_text_color' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_table_of_content_close_button_text_color'),
                ...
                'eael_ext_table_of_content_list_text_color' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_table_of_content_list_text_color'),
                'eael_ext_table_of_content_list_text_color_active' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_table_of_content_list_text_color_active'),
                'eael_ext_table_of_list_hover_color' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_table_of_list_hover_color'),
                'eael_ext_table_of_content_list_separator_style' => $document->get_settings('eael_ext_table_of_content_list_separator_style'),
                'eael_ext_table_of_content_list_separator_color' => $this->eael_ext_toc_fetch_color_or_global_color($document_settings, 'eael_ext_table_of_content_list_separator_color'),
    ...
    public function eael_ext_toc_fetch_color_or_global_color($settings, $control_name=''){
